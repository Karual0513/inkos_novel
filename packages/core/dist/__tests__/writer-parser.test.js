...
import { parseWriterOutput } from "../agents/writer-parser.js";
const defaultGenreProfile = {
    name: "测试",
    id: "test",
    chapterTypes: [],
    fatigueWords: [],
...
function callParseOutput(chapterNumber, content, genreProfile = defaultGenreProfile) {
