...
function buildDimensionList(gp, bookRules, hasParentCanon = false) {
...
export class ContinuityAuditor extends BaseAgent {
    ...
    async auditChapter(bookDir, chapterContent, chapterNumber, genre, options) {
        const [currentState, ledger, hooks, styleGuideRaw, subplotBoard, emotionalArcs, characterMatrix, chapterSummaries, parentCanon, volumeOutline] = await Promise.all([
