...
export class ChapterAnalyzerAgent extends BaseAgent {
    ...
    async analyzeChapter(input) {
        ...
        const [currentState, ledger, hooks, chapterSummaries, subplotBoard, emotionalArcs, characterMatrix, storyBible, volumeOutline,] = await Promise.all([
    ...
    buildSystemPrompt(book, genreProfile, genreBody, bookRulesBody) {
