...
async function extractPackedPackageJson(packDir) {
...
describe("publish packaging", () => {
    it("replaces workspace dependencies before npm pack", async () => {
        ...
        try {
            ...
            const corePackageJson = JSON.parse(await readFile(resolve(workspaceRoot, "packages/core/package.json"), "utf-8"));
...
//# sourceMappingURL=publish-package.test.js.map