...
export function computeAnalytics(bookId, chapters) {
    ...
    const auditedChapters = chapters.filter((ch) => ch.status !== "drafted" && ch.status !== "drafting" && ch.status !== "card-generated");
