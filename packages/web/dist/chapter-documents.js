...
export async function readBookChapters(contextRoot, bookId) {
...
export async function readChapterDocument(contextRoot, bookId, chapterNumber) {
    const state = new StateManager(contextRoot);
...
export async function saveChapterDocument(contextRoot, payload) {
    const state = new StateManager(contextRoot);
...
export async function findChapterFileName(bookDir, chapterNumber, fallbackTitle) {
...
export function parseChapterDocument(chapterNumber, raw, fallbackTitle) {
...
export function rawHeading(chapterNumber, title) {
...
//# sourceMappingURL=chapter-documents.js.map